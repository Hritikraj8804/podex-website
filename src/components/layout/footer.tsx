...
const footerLinks = {
  ...
  community: [
    ...
    { title: "Discussions", href: "https://github.com/Hritikraj8804/podex/discussions" },
  ],
};
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://github.com/Hritikraj8804/podex/discussions" className="text-muted-foreground hover:text-foreground transition-colors" aria-label="Discussions">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
